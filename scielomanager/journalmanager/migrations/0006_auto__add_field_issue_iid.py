...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.iid'
        db.add_column('journalmanager_issue', 'iid',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)

        for issue in orm.Issue.objects.all():
            issue.iid = str(uuid4().hex)
            issue.save()

    def backwards(self, orm):
        # Deleting field 'Issue.iid'
        db.delete_column('journalmanager_issue', 'iid')
    ...
    models = {
        ...
        'journalmanager.issue': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iid': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
