...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Journal.jid'
        db.add_column('journalmanager_journal', 'jid',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)
        for journal in orm.Journal.objects.all():
            journal.jid = str(uuid4().hex)
            journal.save()

    def backwards(self, orm):
        # Deleting field 'Journal.jid'
        db.delete_column('journalmanager_journal', 'jid')
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'is_trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'jid': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
