...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.iid'
        db.alter_column('journalmanager_issue', 'iid', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=32))
        # Adding unique constraint on 'Issue', fields ['iid']
        db.create_unique('journalmanager_issue', ['iid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Issue', fields ['iid']
        db.delete_unique('journalmanager_issue', ['iid'])


        # Changing field 'Issue.iid'
        db.alter_column('journalmanager_issue', 'iid', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
    ...
    models = {
        ...
        'journalmanager.issue': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32'}),
        ...
        'journalmanager.journal': {
            ...
            'is_trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'jid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32'}),
