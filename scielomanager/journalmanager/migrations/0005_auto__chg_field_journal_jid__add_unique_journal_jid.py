...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Journal.jid'
        db.alter_column('journalmanager_journal', 'jid', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=32))
        # Adding unique constraint on 'Journal', fields ['jid']
        db.create_unique('journalmanager_journal', ['jid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Journal', fields ['jid']
        db.delete_unique('journalmanager_journal', ['jid'])


        # Changing field 'Journal.jid'
        db.alter_column('journalmanager_journal', 'jid', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
